...
import com.feirui.auth.application.convert.AuthRolePermissionDTOConverter;
import com.feirui.auth.application.dto.AuthRolePermissionDTO;
import com.feirui.auth.domain.bo.AuthRolePermissionBO;
import com.feirui.auth.domain.service.AuthRolePermissionDomainService;
...
public class RolePermissionController {
    ...
    public Result<Boolean> add(@RequestBody AuthRolePermissionDTO authRolePermissionDTO) {
        try {
            ...
            AuthRolePermissionBO rolePermissionBO = AuthRolePermissionDTOConverter.INSTANCE.convert(authRolePermissionDTO);
