...
import com.feirui.auth.application.convert.AuthPermissionDTOConverter;
import com.feirui.auth.application.dto.AuthPermissionDTO;
import com.feirui.auth.domain.bo.AuthPermissionBO;
import com.feirui.auth.domain.service.AuthPermissionDomainService;
...
public class PermissionController {
    ...
    public Result<Boolean> add(@RequestBody AuthPermissionDTO authPermissionDTO) {
        try {
            ...
            AuthPermissionBO permissionBO = AuthPermissionDTOConverter.INSTANCE.convert(authPermissionDTO);
    ...
    public Result<List<String>> getPermission(String userName) {
        try {
            ...
            Preconditions.checkArgument(!StringUtils.isBlank(userName), "用户userName不能为空");
